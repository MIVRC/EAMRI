...
class attFuse_0617(nn.Module):
    ...
    def forward(self, x, e):
        ...
        attn1 = (q_im @ k_eg.transpose(-2, -1)) 
        attn1 = attn1.softmax(dim=-1)

        attn2 = (q_im @ k_im.transpose(-2, -1)) 
        attn2 = attn2.softmax(dim=-1)

        attn = self.a1 * attn1 + self.a2 * attn2
...
class convTranNet_0617(nn.Module):
    """
    ...
    def __init__(self, img_size=320, indim=2, outdim=12, num_head=4, n_DAM=3, isFastmri=False): 
        ...
        """
        super(convTranNet_0617, self).__init__()
        ...
        self.fuse1 = attFuse_0617(indim, 1, outdim, num_head, bias=False) 
        self.fuse2 = attFuse_0617(indim, 1, outdim, num_head, bias=False) 
        self.fuse3 = attFuse_0617(indim, 1, outdim, num_head, bias=False) 
        self.fuse4 = attFuse_0617(indim, 1, outdim, num_head, bias=False) 
