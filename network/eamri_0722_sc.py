...
class rdn_convBlock(nn.Module):
    def __init__(self, convNum = 3, recursiveTime = 3, inChannel = 2, midChannel=16, shift=False):
        ...
        self.dc = dataConsistencyLayer_fastmri(isFastmri=False)
...
class eamri_0722_sc(nn.Module):
    """
    eamri_0722 single coil version
    """
    def __init__(self, 
                indim=2, 
                edgeFeat=16, 
        ...
        """
        super(eamri_0722_sc, self).__init__()
