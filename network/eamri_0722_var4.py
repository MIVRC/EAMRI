...
class eamri_0722_var4(nn.Module):
    """
    ...
    def __init__(self, 
        ...
        """
        super(eamri_0722_var4, self).__init__()
        ...
        # edge module
        self.edgeNet1 = Edge_Net(indim=indim, hiddim=edgeFeat, n_MSRB=n_MSRB) # simple edge block
        self.edgeNet2 = Edge_Net(indim=indim, hiddim=edgeFeat, n_MSRB=n_MSRB) # simple edge block
        self.edgeNet3 = Edge_Net(indim=indim, hiddim=edgeFeat, n_MSRB=n_MSRB) # simple edge block
        self.edgeNet4 = Edge_Net(indim=indim, hiddim=edgeFeat, n_MSRB=n_MSRB) # simple edge block
