...
class rdn_convBlock(nn.Module):
    def __init__(self, convNum = 3, recursiveTime = 3, inChannel = 24, midChannel=32, is_dc=True, isFastmri=False, isMulticoil=False):
    ...
    def forward(self, x1, y=None, m=None):
        x2 = self.conv1(x1)
        x2 = self.LRelu(x2)
        xt = x2
        for i in range(self.rTime):
...
class eamri_0721_var1(nn.Module):
    """
    ...
    def __init__(self, 
        ...
        """
        super(eamri_0721_var1, self).__init__()
