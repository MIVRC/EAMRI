...
class eamri_0722_var1(nn.Module):
    """
    ...
    def __init__(self, 
        ...
        """
        super(eamri_0722_var1, self).__init__()
    ...
    def forward(self, x1, y, m): # (image, kspace, mask)
        ...
        # second stage
        x1 = self.net2(x1, y, m, sens_map) #(B, 2, H, W)

        # third stage
        x1 = self.net3(x1, y, m, sens_map) #(B, 2, H, W)

        x1 = self.net4(x1, y, m, sens_map) #(B, 2, H, W)
