...
class edgeDecode(nn.Module):
    def __init__(self, inFeat=1, outFeat=16, ks=3):
        super(edgeDecode,self).__init__()
...
class attFuse_0617(nn.Module):
    def __init__(self, C, C1, C2, num_heads, bias):
        ...
        super(attFuse_0617, self).__init__()
    ...
    def forward(self, x, e):
        ...
        attn1 = (q_im @ k_eg.transpose(-2, -1)) * self.a1
        attn1 = attn1.softmax(dim=-1)

        attn2 = (q_im @ k_im.transpose(-2, -1)) * self.a2
...
class net_0617(nn.Module):
    ...
    def __init__(self, img_size=320, indim=2, edgeFeat=16, outdim=12, num_head=4, n_DAM=3, isFastmri=False): 
        ...
        # fuse module
        self.fuse1 = attFuse_0617(indim, edgeFeat, outdim, num_head, bias=False) 
        self.fuse2 = attFuse_0617(indim, edgeFeat, outdim, num_head, bias=False) 
        self.fuse3 = attFuse_0617(indim, edgeFeat, outdim, num_head, bias=False) 
        self.fuse4 = attFuse_0617(indim, edgeFeat, outdim, num_head, bias=False) 
...
class attFuse_0617_var1(nn.Module):
    def __init__(self, C, C1, C2, num_heads, bias):
        """
        C: input channel of image 
        C1: input channel of edge
        ...
        super(attFuse_0617_var1, self).__init__()
...
class net_0617_var1(nn.Module):
    ...
    def __init__(self, img_size=320, indim=2, edgeFeat=16, outdim=12, num_head=4, n_DAM=3, isFastmri=False): 
        ...
        """
        super(net_0617_var1, self).__init__()
        ...
        # fuse module
        self.fuse1 = attFuse_0617_var1(indim, edgeFeat, outdim, num_head, bias=False) 
        self.fuse2 = attFuse_0617_var1(indim, edgeFeat, outdim, num_head, bias=False) 
        self.fuse3 = attFuse_0617_var1(indim, edgeFeat, outdim, num_head, bias=False) 
        self.fuse4 = attFuse_0617_var1(indim, edgeFeat, outdim, num_head, bias=False) 
...
class attFuse_0617_var2(nn.Module):
    def __init__(self, C, C1, C2, num_heads, bias):
        """
        C: input channel of image 
        C1: input channel of edge
...
class ori_attFuse(nn.Module):
    def __init__(self, C, C2, num_heads, bias):
        ...
        super(ori_attFuse, self).__init__()
...
class net_0617_var2(nn.Module):
    ...
    def __init__(self, img_size=320, indim=2, edgeFeat=16, outdim=12, num_head=4, n_DAM=3, isFastmri=False): 
        ...
        """
        super(net_0617_var2, self).__init__()
