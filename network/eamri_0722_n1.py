...
class eamri_0722_n1(nn.Module):
    ...
    def __init__(self, 
        ...
        """
        super(eamri_0722_n1, self).__init__()
        ...
        #self.fuse5 = EAM(indim, 1, attdim, num_head, bias=False, shift=shift) 
    ...
    def forward(self, x1, y, m): # (image, kspace, mask)
        ...
        '''
        x2 = self.net5(x1, y, m, sens_map) #(B, 2, H, W)
        e6 = self.edgeNet(x1) 
        x1 = self.fuse5(x2, e6, y, m, sens_map)
        '''
