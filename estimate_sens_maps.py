...
def main_fastmri_nocrop(file1):
    ...
    output_dir = '/home/ET/hanhui/opendata/fastmri_knee_multicoil_dataset/multicoil_val_pdfs_sensitivity_no_crop/' 
...
if __name__ == '__main__':
    ...
    input_dir = '/home/ET/hanhui/opendata/fastmri_knee_multicoil_dataset/multicoil_val_pdfs/' 
    output_dir = '/home/ET/hanhui/opendata/fastmri_knee_multicoil_dataset/multicoil_val_pdfs_sensitivity_no_crop/' 
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
